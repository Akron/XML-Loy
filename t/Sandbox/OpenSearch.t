...
use_ok('MojoX::XML::OpenSearch');

# new
my $osd = MojoX::XML::OpenSearch->new;
is(ref($osd), 'MojoX::XML::OpenSearch', 'new 1');

$osd->add_short_name('KHM');
$osd->add_long_name('Kinder- und Hausmaerchen der Brueder Grimm');
$osd->add_description('Suchen in allen Fassungen aller Maerchen der Brueder Grimm');
$osd->add_tags(qw/Rotkaeppchen Aschenputtel Maerchen/);

ok($osd->contact('search@khm.li'), 'Set Contact');
is($osd->contact, 'search@khm.li', 'Get Contact');

diag $osd->to_pretty_xml;
