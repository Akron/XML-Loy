...
# new
my $as = MojoX::XML::Atom->new('feed');
$as->add_extension('MojoX::XML::ActivityStreams');

is(ref($as), 'MojoX::XML::Atom', 'new 1');
my $as_entry = MojoX::XML::Atom->new('entry');
is(ref($as), 'MojoX::XML::Atom', 'new 2');
