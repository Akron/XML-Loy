...
ok($xml = MojoX::XML->new('test' => { foo => 'bar' }), 'Constructor String with att');
like($xml->to_pretty_xml, qr{<test foo="bar" />}, 'Pretty Print');
like($xml->to_pretty_xml, qr{\Q$pi\E}, 'Pretty Print');

ok($xml = MojoX::XML->new('test' => { foo => 'bar', a => 'b' }), 'Constructor String with att');
like($xml->to_pretty_xml, qr{<test}, 'Pretty Print');
like($xml->to_pretty_xml, qr{foo="bar"}, 'Pretty Print');
like($xml->to_pretty_xml, qr{a="b"}, 'Pretty Print');
like($xml->to_pretty_xml, qr{\Q$pi\E}, 'Pretty Print');

ok($xml = MojoX::XML->new('test' => { foo => 'bar', a => 'b' } => 'Text'), 'Constructor String with att and Text');
like($xml->to_pretty_xml, qr{<test}, 'Pretty Print');
like($xml->to_pretty_xml, qr{foo="bar"}, 'Pretty Print');
like($xml->to_pretty_xml, qr{a="b"}, 'Pretty Print');
...
ok($xml = MojoX::XML->new(test => 'Text'), 'Constructor String with text');
like($xml->to_pretty_xml, qr{<test}, 'Pretty Print');
like($xml->to_pretty_xml, qr{>Text<}, 'Pretty Print');
like($xml->to_pretty_xml, qr{\Q$pi\E}, 'Pretty Print');
...
ok($xml = MojoX::XML->new(test => 'Text' => 'Comment'),
...
ok($xml = MojoX::XML->new(test => undef, 'Comment'),
