package MojoX::XML::Date::RFC3339;
use strict;
use warnings;
...
MojoX::XML::Date::RFC3339 - Date strings according to RFC3339
...
L<MojoX::XML::Date::RFC3339> implements date and time functions
...
L<MojoX::XML::Date::RFC3339> implements the following attributes.
...
L<MojoX::XML::Date::RFC3339> implements the following methods.


=head2 new

  my $date = MojoX::XML::Date::RFC3339->new;
  my $date = MojoX::XML::Date::RFC3339->new($string);

Construct a new L<MojoX::XML::Date::RFC3339> object.
